...
urlpatterns = [
    ...
    path('inscribir-alumno/', views.inscribir_alumno, name='inscribir_alumno'),
    ...
    path('movimientos/<int:alumno_id>/', views.consultar_movimientos, name='consultar_movimientos'),
    ...
    path('asignar_tarea/<int:alumno_id>/<int:curso_id>/<int:proyecto_id>/', views.asignar_tarea, name='asignar_tarea'),
